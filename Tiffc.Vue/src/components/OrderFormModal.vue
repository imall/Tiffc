...
const modalTitle = '建立訂單'
const submitText = '建立訂單'
const submitLoadingText = '建立中...'
...
<template>
  <BaseFormModal :visible="visible" :title="modalTitle" :submitting="submitting" :submit-text="submitText"
